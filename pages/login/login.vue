<template>
	<view class="u-page dom-login" :style="{ height: view.Height + 'px' }">
		...
		<view class="u-demo-block">
			...
			<view class="u-demo-block__content"><u--input v-model="formInline.username" placeholder="请输入账号" border="surround" clearable></u--input></view>
		</view>

		<view class="u-demo-block">
			<text class="u-demo-block__title">密码</text>
			<view class="u-demo-block__content">
				<u--input v-model="formInline.password" :password="pwdIconName === 'eye-off'" placeholder="请输入密码" border="surround">
					<template slot="suffix">
						<u-icon :name="pwdIconName" color="#2979ff" @click="pwdIconName = pwdIconName === 'eye-fill' ? 'eye-off' : 'eye-fill'"></u-icon>
					</template>
				</u--input>
			</view>
		</view>
		...
		<view class="u-demo-block">
			<u-button :disabled="formInline.username === '' || formInline.password === ''" type="primary" text="登 录" @click="handelLogin"></u-button>
		</view>
	</view>
</template>
