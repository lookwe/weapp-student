	...
	<view class="mod-home u-page">
		<view class="mod-school flex jsb">
			<view class="mod-school__info">
					<image mode="scaleToFill" :src="'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fup.enterdesk.com%2Fedpic%2Fec%2Fca%2Fd8%2Feccad87a334d082b8ff200ae01157e44.jpg&refer=http%3A%2F%2Fup.enterdesk.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1641361652&t=1439f13fd58db29e78ae81a6c2034ef0'"
						@error="imageError">
					</image>
		...
		<view class="mod-course-list u-box">
			<view class="u-box__title">
				精选课程
			</view>
			<view class="u-box__content">
				<view class="course-item" v-for="item in [1,2,3,4]" :key="item" @click="toCourseDetails">
					<image mode="scaleToFill" :src="'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fup.enterdesk.com%2Fedpic%2Fec%2Fca%2Fd8%2Feccad87a334d082b8ff200ae01157e44.jpg&refer=http%3A%2F%2Fup.enterdesk.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1641361652&t=1439f13fd58db29e78ae81a6c2034ef0'"
						@error="imageError">
					</image>
					<view class="fz-15 mod-course-name">
						大神设计师带你学大神设计师带你学师带你学大神设计师带你学
					</view>
	...
	.mod-school {
		...
		&__info {
			...
			image {
				...
				width: 40px; height: 40px; background-color: #eeeeee;
				border-radius: 3px;
			}
			.fw-600 {
				margin-left: 10px;
