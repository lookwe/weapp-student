  ...
  <view class="mod-home u-page">
    <view class="mod-school flex jsb">
      <view class="mod-school__info">
        <image
          mode="scaleToFill"
          :src="'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fup.enterdesk.com%2Fedpic%2Fec%2Fca%2Fd8%2Feccad87a334d082b8ff200ae01157e44.jpg&refer=http%3A%2F%2Fup.enterdesk.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1641361652&t=1439f13fd58db29e78ae81a6c2034ef0'"
          @error="imageError"
        >
        </image>
    ...
    <view class="mod-member u-box">
      <text @click="isVip = 2" :class="['vip', isVip == 2 ? 'is-active' : '']"
        >VIP课</text
      >
      <text @click="isVip = 1" :class="[isVip == 1 ? 'is-active' : '']"
        >公开课</text
      >
    </view>
