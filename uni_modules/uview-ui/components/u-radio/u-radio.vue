  ...
  >
    <view>
      <view
        ...
        :class="iconClasses"
        :style="[isDefaCSS ? iconWrapStyle : coutomStyle]"
      >
        {{ indexToWORD(name) }}
      </view>
    </view>
    ...
    <text
      class="u-radio__text com-parse-html"
  ...
  computed: {
    ...
    elIconColor() {
      ...
      if (this.elDisabled) {
        ...
        return this.checked ? this.elInactiveColor : '#666'
      } else {
        return this.checked ? iconColor : '#666'
      }
    },
    iconClasses() {
      let classes = []
...
.u-radio {
  ...
  &__icon-wrap {
    ...
    &--disabled {
      background-color: $u-radio-disabled-background-color;
    }

    &--disabled--checked {
      color: $u-radio-disabled--checked-color;
    }
  }
